...
<style>
.sidebar {width:80px;height:100%;background:#fff;position:fixed;top:0;left:0;border-right:1px solid #eee;display:flex;flex-direction:column;align-items:center;padding-top:10px;}
.sidebar a {color:#555;text-decoration:none;font-size:20px;margin:20px 0;transition:0.3s;}
.sidebar a:hover,.sidebar a.active{color:#00a86b;}
.topbar{position:fixed;left:80px;right:0;top:0;height:60px;background:#fff;border-bottom:1px solid #eee;display:flex;align-items:center;justify-content:space-between;padding:0 20px;z-index:100;}
.search-bar input{border:none;background:#f2f6f4;padding:6px 12px;border-radius:20px;outline:none;width:220px;}
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody id="groupTableBody">
                        ...
                        <tr><td colspan="8" class="text-center">Chưa có đoàn nào</td></tr>
                        <?php else: ?>
        ...
        <div class="modal-content">
            <form method="POST" id="groupForm">
                <div class="modal-header">
                    <h5 class="modal-title">Thêm / Sửa Đoàn</h5>
